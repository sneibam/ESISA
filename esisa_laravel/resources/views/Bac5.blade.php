     ...
     <div style="margin-bottom:2%;" class="lastRow">
      ...
      <div class="mydiv sidenav" style="margin-top:5%">
        ...
        <div class="column2" style="padding-left:2%;font-size:2vw;">
            <div class="rowB">
                <div class="columnB">
                  <p style="color:#1962e5;font-size:1.3vw;margin-top:2.1%;">Ingénierie Informatique Décisionnelle Appliquée à la Finance(IIDAF) :</p>
                  <a href="{{ asset('pdf/IIDAF.pdf') }}"><img src="{{asset('images/images4/IIDAF.png')}}" style="max-width:100%" height="600" class="thumbnail" /></a>
                </div>
                <div class="columnB columnB2">
                    <p style="color:#1962e5;font-size:1.3vw;margin-top:2.1%; margin-bottom: 10.5%;">Ingénierie des Systèmes d'Information(ISI) :</p>
                    <a href="{{ asset('pdf/ISI-NV.pdf') }}"><img src="{{asset('images/images4/ISI.png')}}" style="max-width:100%" height="600" class="thumbnail" /></a>
                </div>
            </div>
            <div class="rowB">
                <div class="columnB">
                    <p style="color:#1962e5;font-size:1.3vw;margin-top:2.1%;">Ingénierie des Systèmes Distribués(ISD) :</p>
                    <a href="{{ asset('pdf/ISD-NV.pdf') }}"><img src="{{asset('images/images4/ISD.png')}}" style="max-width:100%" height="600" class="thumbnail" /></a>
                </div>
            </div>
        </div>
    </div>
