      ...
      <table style="margin-top: auto;">
        ...
        <div class="column2 " style="padding-left:0.6%">
            ...
            <div style="font-size:1vw;font-family:'calibri'">
                <p align="justify">
                    Vous pouvez déposer vos offres d'emploi qui seront diffusées auprès de nos élèves de dernière année, ainsi qu'à nos anciens élèves, à l'adresse suivante : <a style="color:#428bca">emplois@esisa.ac.ma</a>
                </p>

                <img src="{{asset('images/images4/entreprise2.jpg')}}" height="240" width="400" style="max-width:100%; margin-left:25%;" class="thumbnail" />
