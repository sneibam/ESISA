     ...
     <div style="margin-bottom:2%;" class="lastRow">
      ...
      <table style="margin-top: auto;">
        ...
        <div class="column2" style="padding-left:2%;font-size:2vw;">
            <p style="color:#1962e5;font-size:1.3vw;margin-top:2.1%;">
                Soirée de fin d'année - 2015 :
            </p>
            <div>
                <img src="{{asset('images/images5/1(2).jpg')}}" style="max-width:100%;margin-right:16%" width="300" height="392" class="thumbnail" />

                <img src="{{asset('images/images5/2(2).jpg')}}" style="max-width:100%;" width="300" height="392" class="thumbnail" />

                <img src="{{asset('images/images5/3(2).jpg')}}" style="max-width:100%;margin-right:16%" width="300" height="392" class="thumbnail" />

                <img src="{{asset('images/images5/4(2).jpg')}}" style="max-width:100%;" width="300" height="392" class="thumbnail" />

                <img src="{{asset('images/images5/5(2).jpg')}}" style="max-width:100%;margin-right:16%" width="300" height="392" class="thumbnail" />

                <img src="{{asset('images/images5/6(2).jpg')}}" style="max-width:100%;" width="300" height="392" class="thumbnail" />
