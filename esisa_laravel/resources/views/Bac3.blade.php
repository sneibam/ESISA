     ...
     <div style="margin-bottom:2%;" class="lastRow">
      ...
      <div class="mydiv sidenav" style="margin-top:5%">
        ...
        <div class="column2" style="padding-left:2%;font-size:2vw;">
            ...
            <div class="rowB">
                 <div class="columnB">
                     <p style="color:#1962e5;font-size:1.3vw;margin-top:2.1%;">Ingénierie Logiciel(IL) :</p>
                     <a href="{{ asset('pdf/IL.pdf') }}"><img src="{{asset('images/images4/IL.png')}}" style="max-width:100%; margin-top: 5.3%;" height="600" class="thumbnail"/></a>
                 </div>
                 <div class="columnB columnB2">
                     <p style="color:#1962e5;font-size:1.3vw;margin-top:2.1%;">Informatique Appliquée à la Gestion et la Finance(IAGF) :</p>
                     <a href="{{ asset('pdf/IAGF.pdf') }}"><img src="{{asset('images/images4/IGAF.png')}}" style="max-width:100%" height="600" class="thumbnail" /></a>
                 </div>
            </div>
        </div>
    </div>
