...
<body style="background-color:#f8f8f8">
    ...
    <div style="margin-left:2%;" class="column">
      ...
      <div style="margin-bottom:2%;">
          ...
          <a href="https://polytech.univ-amu.fr/" style="padding-left:0%;" class="p12"><img src="{{asset('images/images/PM.png')}}" class="Panneau" style="max-width:100%;height:auto;" /></a>


          <a href="http://www.eilco-ulco.fr/" style="padding-left:0%;" class="p13">
                        <img src="{{asset('images/images/eil.png')}}" class="Panneau" class="Panneau" style="max-width:100%;height:auto;" />
                    </a>


          <a href="https://www.isima.fr/" style="padding-left:0%;" class="p14"><img src="{{asset('images/images/CLA.jpeg')}}" class="Panneau" style="max-width:100%;height:auto;" /></a>
      ...
      <div style="margin-bottom:2%;">
          ...
          <a href="https://www.lsis.org/" style="padding-left:0%;" class="p22"><img src="{{asset('images/images/lsis.jpg')}}" class="Panneau" style="max-width:100%;height:auto;" /></a>
          <a href="http://www.univ-lorraine.fr/" style="padding-left:0%;" class="p23">
                        <img src="{{asset('images/images/logo-universite-de-lorraine.png')}}" class="Panneau" style="max-width:100%;height:auto;" />
                    </a>


          <a href="http://www.uca.fr/" style="padding-left:0%;" class="p24"><img src="{{asset('images/images/cla2.jpg')}}" class="Panneau" style="max-width:100%;height:auto;" /></a>
      ...
      <div style="margin-bottom:2%;">
        ...
        <a href="http://www.univ-lorraine.fr/" class="p23responsive">
          ...
          <a href="https://www.univ-paris13.fr/" style="padding-left:0%;" class="p32"><img src="{{asset('images/images/USPC-PARIS13-1.png')}}" class="Panneau" style="max-width:100%;height:auto;" /></a>


          <a href="http://www.u-bourgogne.fr/" style="padding-left:0%;" class="p33"><img src="{{asset('images/images/ubourgogne_logo.jpg')}}" class="Panneau" style="max-width:100%;height:auto;" /></a>

          <a href="https://www.u-cergy.fr/fr/index.html" style="padding-left:0%;" class="p34"><img src="{{asset('images/images/Universite_de_Cergy-Pontoise_(logo).svg.png')}}" class="Panneau" style="max-width:100%;height:auto;" /></a>
      ...
      <div style="margin-bottom:2%;">
        ...
        <a href="http://www.u-bourgogne.fr/"  class="p33responsive"><img src="{{asset('images/images/ubourgogne_logo.jpg')}}" class="Panneau" style="max-width:100%;height:auto;" /></a>
          ...
          <a href="https://unige.it/" style="padding-left:0%;" class="p42"><img src="{{asset('images/images/diptem_big_1.jpg')}}" class="Panneau" style="max-width:100%;height:auto;" /></a>

          <a href="http://www.univ-fcomte.fr/pages/fr/ea-4269---lifc-8136.html" style="padding-left:0%;" class="p43">
     ...
     <div style="margin-bottom:2%;" class="lastRow">
       ...
       <a href="https://unige.it/" style="padding-left:0%;" ><img src="{{asset('images/images/diptem_big_1.jpg')}}" class="Panneau" style="max-width:100%;height:auto;" /></a>

       <a href="http://www.univ-fcomte.fr/pages/fr/ea-4269---lifc-8136.html" style="padding-left:0%;">
         <img src="{{asset('images/images/lifc.jpg')}}" class="Panneau" style="max-width:100%;height:auto;" />
       </a>
     </div>
      ...
      <table style="margin-top: auto;">
        ...
        <div class="column2" style="padding-left:2%;font-size:2vw;">
            ...
            <table>
                <tr>
                    <td class="thumbnail" style="width:40%;">
                        <img src="{{asset('images/images5/2.jpg')}}" style="max-width:100%;" width="400" height="200" />
                        <p style="margin-top:-0.5%;margin-left:1%">
                            <a class="button button2" style="height:auto;font-size:15px;" href="Lartiste-Event">Plus d'images>></a>
                        </p>
                    </td>

                    <td class="thumbnail" style="width:40%;">
                        <img src="{{asset('images/images5/2(1).jpg')}}" style="max-width:100%;" width="400" height="200" />
                        <p style="margin-top:-0.5%;margin-left:1%">
                            <a class="button button2" style="height:auto;font-size:15px;" href="Douzi-Event">Plus d'images>></a>
                        </p>
                    </td>
                </tr>
                <tr>
                    <td class="thumbnail" style="width:40%;">
                        <img src="{{asset('images/images5/2(2).jpg')}}" style="max-width:100%;" width="400" height="200" />
                        <p style="margin-top:-0.5%;margin-left:1%">
                            <a class="button button2" style="height:auto;font-size:15px;" href="Saida-Event">Plus d'images>></a>
                        </p>
                    </td>
                </tr>
            </table>
