      ...
      <div class="mydiv sidenav" style="margin-top:5%">
        ...
        <div class="column2 " style="padding-left:2%;">
            ...
            <div style="font-size:1vw;font-family:'calibri'">
                ...
                <img src="{{asset('images/images4/entreprise_partenaires.jpg')}}" height="600" width="800" style="max-width:100%;" class="thumbnail" />

                <p style="color:#1962e5;font-size:1.3vw;margin-top:0.8%;">
                    PARTENAIRES À L'ÉTRANGER :
                </p>
                <img src="{{asset('images/images4/entreprises_etranger.jpg')}}" height="140" width="800" style="max-width:100%;" class="thumbnail" />
            </div>
