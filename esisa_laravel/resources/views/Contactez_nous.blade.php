     ...
     <div style="margin-bottom:2%;" class="lastRow">
      ...
      <div class="mydiv sidenav" style="margin-top:5%">
        ...
        <div class="column2" style="padding-left:2%;font-size:2vw;">
          {!! Form::open(['route' => 'contactus.sendmail']) !!}

          <div class="form-group">
            <div class="form-labels">{!! Form::label('gender', 'Genre') !!}  *</div>
            <div class="radio-buttons">
              {!! Form::radio('gender','Homme', true, ['id' => 'gender'])!!} Homme<br />
              {!! Form::radio('gender','Femme', ['id' => 'gender'] )!!} Femme
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
              <div class="form-labels">{!! Form::label('subject', 'Sujet') !!}</div>
              {!! Form::text('subject', null, ['class' => 'form-control', 'id' => 'subject']) !!}
          </div>

          <div class="form-group">
              <div class="form-labels">{!! Form::label('msg', 'Message') !!}  *</div>
              {!! Form::textarea('msg', null, ['class' => 'form-control', 'id' => 'msg']) !!}
          </div>

          {!! Form::submit('Envoyer', ['class' => 'btn btn-info' , 'onclick' => 'validateContactForm()']) !!}
