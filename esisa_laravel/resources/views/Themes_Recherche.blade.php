     ...
     <div style="margin-bottom:2%;" class="lastRow">
      ...
      <table style="margin-top: auto;">
        ...
        <div class=\"column2 \" style=\"padding-left:2%;font-size:2vw\">
            <p style="color:#1962e5;font-size:1.3vw;margin-top:0.5%;">THEMES DE RECHERCHE :</p>
            <p align="justify">La recherche a été initiée à l'ESISA par son Président et Directeur pédagogique M. MEKOUAR Khalid après son palmarès glorieux en France (Nice Sophia Antipolis) Prix Sadi Carnot 1991.</p>

            <p style="color:#1962e5;font-size:1.3vw;margin-top:0.5%;">Thèmes de recherche:</p>
            <ul>
                <li>
            ...
            <p align="justify">L'ESISA est considérée comme un cycle préparatoire à la recherche. Elle donne le gout et les moyens nécessaires de la recherche à ses jeunes étudiants en leur apprenant les bonnes démarches et méthodes pour y aboutir et en les initiant aux nouvelles technologies.</p>
        </div>
    </div>
