     ...
     <div style="margin-bottom:2%;" class="lastRow">
      ...
      <div class="mydiv sidenav" style="margin-top:5%">
        ...
        <div class="column2" style="padding-left:2%;font-size:2vw;">
            <p style="color:#1962e5;font-size:1.3vw;margin-top:2.1%;">
                Soirée de gala DOUZI - 2016 :
            </p>
            <div class="container">
              <div class="row">
                <div class="col">
                    <img src="{{asset('images/images5/1(1).jpg')}}" style="max-width:100%;height:auto;margin-right:16%" width="100%" class="thumbnail" />
                </div>
                <div class="col">
                    <img src="{{asset('images/images5/2(1).jpg')}}" style="max-width:100%;" width="100%" height="90%" class="thumbnail" />
                </div>
              </div>
              <div class="row">
                <div class="col">
                    <img src="{{asset('images/images5/3(1).jpg')}}" style="max-width:100%;margin-right:16%" width="100%" height="auto" class="thumbnail" />
                </div>
                <div class="col">
                    <img src="{{asset('images/images5/4(1).jpg')}}" style="max-width:100%;" width="100%" height="auto" class="thumbnail" />
                </div>
              </div>
              <div class="row">
                <div class="col">
                    <img src="{{asset('images/images5/5(1).jpg')}}" style="max-width:100%;margin-right:16%" width="100%" height="auto" class="thumbnail" />
                </div>
                <div class="col">
                    <img src="{{asset('images/images5/6(1).jpg')}}" style="max-width:100%;" width="100%" height="auto" class="thumbnail" />
                </div>
              </div>
              <div class="row">
                <div class="col">
                    <img src="{{asset('images/images5/7(1).jpg')}}" style="max-width:100%;margin-right:16%" width="100%" height="auto" class="thumbnail" />
                </div>
                <div class="col">
                    <img src="{{asset('images/images5/8(1).jpg')}}" style="max-width:100%;" width="100%" height="auto" class="thumbnail" />
                </div>
              </div>
              <div class="row">
                <div class="col">
                    <img src="{{asset('images/images5/9(1).jpg')}}" style="max-width:100%;margin-right:16%" width="100%" height="auto" class="thumbnail" />
                </div>
                <div class="col">
                    <img src="{{asset('images/images5/10(1).jpg')}}" style="max-width:100%;" width="100%" height="auto" class="thumbnail" />
                </div>
              </div>
            </div>
            <!-- <div>
                <img src="{{asset('images/images5/1(1).jpg')}}" style="max-width:100%;margin-right:16%" width="300"height="392" class="thumbnail" />

                <img src="{{asset('images/images5/2(1).jpg')}}" style="max-width:100%;" width="300" height="392" class="thumbnail" />

                <img src="{{asset('images/images5/3(1).jpg')}}" style="max-width:100%;margin-right:16%" width="300" height="392" class="thumbnail" />

                <img src="{{asset('images/images5/4(1).jpg')}}" style="max-width:100%;" width="300" height="392" class="thumbnail" />

                <img src="{{asset('images/images5/5(1).jpg')}}" style="max-width:100%;margin-right:16%" width="300" height="392" class="thumbnail" />

                <img src="{{asset('images/images5/6(1).jpg')}}" style="max-width:100%;" width="300" height="392" class="thumbnail" />

                <img src="{{asset('images/images5/7(1).jpg')}}" style="max-width:100%;margin-right:16%" width="300" height="392" class="thumbnail" />

                <img src="{{asset('images/images5/8(1).jpg')}}" style="max-width:100%;" width="300" height="392" class="thumbnail" />

                <img src="{{asset('images/images5/9(1).jpg')}}" style="max-width:100%;margin-right:16%" width="300" height="392" class="thumbnail" />

                <img src="{{asset('images/images5/10(1).jpg')}}" style="max-width:100%;" width="300" height="392" class="thumbnail" />
