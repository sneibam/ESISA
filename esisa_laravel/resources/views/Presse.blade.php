            ...
            <table>
                <tr style="font-size:1vw">
                    <td style="padding-right:0.2%; padding-bottom:1.6%">
                        ...
                        <a style="color:#1962e5" href="{{ asset('pdf/matin04.pdf') }}">Le matin 2004</a>
                    </td>
                    <td style="padding-right:0.2%; padding-bottom:1.6%">
                        <img src="{{asset('images/images4/pdf.png')}}" style="float:left" />
                        <a style="color:#1962e5" href="{{ asset('pdf/matin05.pdf') }}">Le matin 2005 </a>
                    </td>
                    <td style="padding-right:0.2%; padding-bottom:1.6%">
                        <img src="{{asset('images/images4/pdf.png')}}" style="float:left" />
                        <a style="color:#1962e5" href="{{ asset('pdf/opinion07.pdf') }}">L'opinion 2007</a>
                    </td>
                    <td style="padding-right:0.2%; padding-bottom:1.6%">
                        <img src="{{asset('images/images4/pdf.png')}}" style="float:left" />
                        <a style="color:#1962e5" href="{{ asset('pdf/opinion072.pdf') }}"> L'opinion 2007 </a>
                    </td>
                ...
                <tr style="font-size:1vw">
                    <td style="padding-right:0.2%; padding-bottom:1.6%">
                        <img src="{{asset('images/images4/pdf.png')}}" style="float:left" />
                        <a style="color:#1962e5" href="{{ asset('pdf/liberation 10.pdf') }}">  Liberation 2010</a>
                    </td>
                    <td style="padding-right:0.2%; padding-bottom:1.6%">
                        <img src="{{asset('images/images4/pdf.png')}}" style="float:left" />
                        <a style="color:#1962e5" href="{{ asset('pdf/lopinion10.pdf') }}"> L'opinion 2010</a>
                    </td>
                    <td style="padding-right:0.2%; padding-bottom:1.6%">
                        <img src="{{asset('images/images4/pdf.png')}}" style="float:left" />
                        <a style="color:#1962e5" href="{{ asset('pdf/economiste_frontieres_numeriques_2014.pdf') }}"> L'economiste 2014</a>
                    </td>
                    <td style="padding-right:0.2%; padding-bottom:1.6%">
                        <img src="{{asset('images/images4/pdf.png')}}" style="float:left" />
                        <a style="color:#1962e5" href="{{ asset('pdf/economiste_frontieres_numeriques_2014_2.pdf') }}"> L'economiste 2014 </a>
                    </td>
