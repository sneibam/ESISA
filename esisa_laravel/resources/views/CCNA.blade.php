     ...
     <div style="margin-bottom:2%;" class="lastRow">
      ...
      <table style="margin-top: auto;">
        ...
        <div class="column2 " style="padding-left:2%;font-size:2vw;">
            <p style="color:#1962e5;font-size:1.3vw;margin-top:0.5%;">FORMATION CCNA :</p>
            <p align="justify">Les systèmes et réseaux informatiques font désormais partie intégrante de tous les domaines des technologies de l'information. L’ingénierie des réseaux est maintenant une discipline bien établie qui intègre à la fois les connaissances théoriques des réseaux, que pratiques : Techniques de conception et méthodes de mise en oeuvre.</p>
            <p align="justify">La certification académique CCNA (Cisco Certified Networking Academy) compte environ 80h de formation (cours, travaux pratiques, Examens) et s’adresse aux personnes désirant acquérir une formation solide dans le domaine des réseaux informatiques, l’interconnexion des réseaux et la mise en oeuvre de réseaux informatiques. Aucune connaissance dans le domaine des réseaux n’est requise.</p>
            <p align="justify">Des certificats académiques Cisco seront délivrés aux stagiaires à la fin de la formation ainsi qu’une attestation de formation délivrée par la direction de l’ESISA.</p>
            <p align="justify">Les cours seront animés par des experts du domaine certifiés en tant qu’instructeur sur les produits objets de cette formation. Les cours sont composés de plusieurs chapitres. Chaque chapitre commencera par un exposé théorique, où le formateur explique les fondements ou les fonctionnalités étudiées. Ces exposés seront appuyés par des manipulations pratiques par les stagiaires afin qu’ils assimilent au mieux les concepts vus dans le cours.</p>

            <p style="color:#1962e5;font-size:1.3vw;margin-top:0.5%;">CONTENU DE LA CERTIFICATION CISCO CCNA :</p>
            <table id="customers">
                <tr>
                    <th>Certification Cisco, Technologie des reseaux informatiques</th>

                </tr>
                <tr>
                    <td>Technologies de base des réseaux (15h)</td>
                    <td style="font-weight:bold">Cours CCNA1</td>
                </tr>
                <tr>
                    <td>Technologies pour le routage (12h)</td>
                    <td style="font-weight:bold">Cours CCNA2</td>
                </tr>
                <tr>
                    <td>Technologies pour la commutation "switching"(12h)</td>
                    <td style="font-weight:bold">Cours CCNA3</td>
                </tr>
                <tr>
                    <td>Technologies des reseaux WANs (12h)</td>
                    <td style="font-weight:bold">Cours CCNA4</td>
                </tr>
